...
const FEATURE_PREVIEW_MODAL_SUBTITLE =
  "Try upcoming product experiences before they become generally available.";
// TODO: Update this link to the dedicated Langfuse Assistant feedback discussion.
const FEATURE_PREVIEW_FEEDBACK_URL =
          ...
          <section className="bg-background min-h-0 overflow-y-auto p-6">
            ...
            <div className="mt-5">
              <Button variant="secondary" asChild>
                <a
                  href={FEATURE_PREVIEW_FEEDBACK_URL}
                  target="_blank"
                  rel="noreferrer"
                >
                  Provide feedback
