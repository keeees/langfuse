...
export const [listEvaluationRulesTool, handleListEvaluationRules] = defineTool({
  ...
  description:
    "List evaluation rules in the current EvalBear project. Each rule attaches an evaluator to incoming observations or experiment items. Results are paginated.",
