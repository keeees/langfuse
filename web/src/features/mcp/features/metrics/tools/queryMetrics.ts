...
export const [queryMetricsTool, handleQueryMetrics] = defineTool({
  name: "queryMetrics",
  description:
    "Answer analytics questions about the current EvalBear project, such as usage over time, model costs, latency, errors, scores, or grouped breakdowns by environment, trace, observation, model, user, session, tag, or score name.",
