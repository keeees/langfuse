 ...
 *
 * This endpoint implements the MCP protocol for EvalBear, enabling AI assistants
 * like Claude Desktop and Cursor to directly query, create, and manage EvalBear prompts.
 *
 * Architecture:
 * - Stateless per-request pattern (fresh server instance per request)
 * - Streamable HTTP transport (2025-03-26 spec)
 * - BasicAuth using EvalBear API keys
